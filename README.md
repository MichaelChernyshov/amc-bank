...
This is project about a potential bank in Spain, where you can order a card with it's own brand and use more services of this bank.
...
<img src="https://cdn.vuetifyjs.com/docs/images/logos/vuetify-logo-v3-slim-text-light.svg" width="90px">

And also vue router, vee-validate

### Main goal

Create a bank website which will like all the people with nice interface and all services of the bank for people.
...
* Add more debit and credit cards 
* Add loans on the website 
* Make better UI and UX design
