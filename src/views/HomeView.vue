...
<template>
  <main>
    ...
    fImgLink="./src/assets/images/icons/iphone-icon.svg" 
    sCardTitle="Registration" 
    sCardDescription="Fill all forms to end registration" 
    sImgLink="./src/assets/images/icons/folderGuide.svg" 
    tCardTitle="Using" 
    tCardDescription="Now you can start using you cards in app of our bank" 
    tImgLink="./src/assets/images/icons/CardsGuide.svg"></GuidesMain>
  </main>
</template>
